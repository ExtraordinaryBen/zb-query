...
var getposturl, d, postid, ipost, msg, ximg;
if (!ximg){
ximg ="http://www.majhost.com/gallery/Karkuta/pics/MoS-Buttons/q_edit.png";
}

$("body").append('<div id="storage" style="display:none;"></div>');
$("img[alt=Edit Post]").each(function() {
$(this).parents(".left").next().prepend("<img class='qedit' src='"+ximg+"' alt='QuickEdit' style='cursor:pointer;'/> ")
});
